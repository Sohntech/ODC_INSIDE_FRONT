  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" 
      ...
      <div className="relative">
        {/* Green background card shifted down */}
        <div className="absolute top-2 left-0 max-w-md w-full bg-green-500 rounded-3xl h-full"></div>
        
        {/* Orange background card shifted right */}
        <div className="absolute top-0 left-2 max-w-md w-full bg-yellow-500 rounded-3xl h-full"></div>
        
        {/* Main white card */}
        <div className="max-w-md w-full bg-white rounded-3xl shadow-lg overflow-hidden relative z-10">
