...
// Interface for Promotion including the fields from EnhancedPromotionCard
interface Promotion {
  id: string;
  name: string;
  ...
  if (!promotion) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <Link href="/dashboard/promotions" className="text-orange-600 hover:text-orange-800 flex items-center">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-center text-gray-700">
                ...
                <div>
                  ...
                  <p className="text-sm">{promotion.learnerCount || promotion.learners?.length || 0} inscrits</p>
                </div>
              </div>
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="p-3">
        ...
        <h3 className="font-medium text-orange-600 text-sm mb-1">
          {referential.name}
        </h3>
        ...
        {/* Orange divider */}
        <div className="h-0.5 w-12 bg-orange-500 mb-2"></div>
